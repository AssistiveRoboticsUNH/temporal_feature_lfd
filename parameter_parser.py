...
class Parameters:
    ...
    def setup_block_stacking(self):
        ...
        self.file_directory = os.path.join(ROOT_DIR, "datasets/BlockConstructionV2/")
        self.num_actions = 7
...
def default_model_args(use_ditrl=False,
    ...
    parser.set_defaults(trace_file="/home/mbc2004/datasets/BlockConstructionV2/traces4.npy")
