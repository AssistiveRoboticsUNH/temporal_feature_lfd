...
from .dataset_itr import DatasetITR
NUM_TOTAL_ACTIONS = 4


class DatasetITRTrace(DatasetITR):
    def __init__(self, root_path, mode, trace_path, verbose=False, image_tmpl=None, num_segments=3, ablation=False):
        super().__init__(root_path, mode, verbose=verbose)
