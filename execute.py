...
def make_model_name(args, lfd_params, backbone=False):
    ...
    print(f"old_save_dir exists ({old_save_dir}):", os.path.exists(old_save_dir))
    print(f"new_save_dir exists ({new_save_dir}):", os.path.exists(new_save_dir))
...
def train(args, lfd_params, model):
    ...
    if args.app == 'c':
        ...
        elif args.suffix in ['linear', 'lstm', 'tcn', 'linear_iad']:
        ...
        if args.suffix in ['linear', 'lstm', 'tcn', 'linear_iad']:
