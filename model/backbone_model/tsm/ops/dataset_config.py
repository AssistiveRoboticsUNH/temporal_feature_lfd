...
ROOT_DATASET = '/home/mbc2004/datasets/Something-Something/'#'/ssd/video/'  # '/data/jilin/'
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + '20bn-something-something-v2-frames'#'something/v2/20bn-something-something-v2-frames'
        filename_imglist_train = 'annotations/train_videofolder.txt'#'something/v2/train_videofolder.txt'
        filename_imglist_val = 'annotations/small_videofolder.txt'#'something/v2/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
