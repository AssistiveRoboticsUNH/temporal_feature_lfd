...
class MaskedIAD2ITR(torch.autograd.Function):
    ...
    def forward(ctx, iad):
        ...
        # return Graph
        #return itr
        return itr.x, itr.edge_idx, itr.edge_attr
...
class MaskedIAD2ITR_Message(MessagePassing):
    """
    We can implement our own custom autograd Functions by subclassing
    torch.autograd.Function and implementing the forward and backward passes
    which operate on Tensors.
...
if __name__ == '__main__':
    ...
    x, edge_idx, edge_attr = MaskedIAD2ITR_Message.apply(masked_iad)
    print("x:", x)
    #itr = MaskedIAD2ITR_Message.apply(masked_iad)
    #print("itr:", itr)
