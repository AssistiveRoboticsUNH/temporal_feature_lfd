...
class PolicyLearnerBottleneckECO(nn.Module):
    def __init__(self, lfd_params, filename,
        ...
        if use_feature_extractor:
            ...
            self.backbone = BackboneECO(lfd_params, is_training=self.spatial_train, trim_model=True,
    ...
    def forward(self, x, act_x):
        ...
        print("t-1:", x.shape)
        x = x.view(1, act_x.shape[1], -1, self.lfd_params.args.bottleneck_size)
        print("t-0.75:", x.shape)
